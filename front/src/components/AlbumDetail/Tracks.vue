        ...
        <main>
          <section class="content-spacing">
            <div class="que-detail">
              ...
              <div class="action-bar-row mb-2">
                <div class="action-arranger">
                  <button class="play-artist">
                      <span class="encore-theme btn-inner" @click="changeSong(album.uri,1)">
              ...
              <div class="grid-arranger" style="height: calc(100% - 1008);" v-for="(tracks,i) in album.tracks.items">
                <div class="list-num">
                  <div class="list-num-style">
                    <span class="number">
                      {{parseInt(i+1)}}
                    </span>
                    <button class="play-track" @click="changeSong(album.uri,tracks.track_number)">
                ...
                <div class="list-img">
                  <img aria-hidden="false" draggable="false" loading="eager" :src="album.images[0].url" :alt="tracks.name" width="40" height="40">
                  <div class="list-name">
                    <div class="track-link" >{{ tracks.name }}</div>
                    <span class="list-artist" >
                      <span  @click="navigateTo({name:'artist',params:{artist:tracks.artists[0].id}})" >
                ...
                <div class="album-arranger">
                  <div class="title">
                    <span class="titled">{{album.name}}</span>
                  </div>
                </div>
                <div class="date-arranger">
                  <div class="title">
                    <span class="titled">{{album.release_date}}</span>
                  </div>
                </div>
