<template>
  <section class="discography mt-1r">
    <div class="discography-grid">
      <div class="discography-flex">
        <div class="discography-header">
          <h2>Tracks That You Love</h2>
        </div>
      </div>
    </div>
    <CardLoader v-if="loader === true" :column="column" />
    <div class="grid-container" v-if="loader === false" :style="'--column-count:'+column+';'">
      <div class="card-container" v-for="albums in topTracks.topTracks.items.slice(0,column)">
        <div class="card-height" @click="changeSong(albums.album.uri,1)">
          <div class="card-img">
            <div class="card-img-arranger">
              <img :src="albums.album.images[0].url || albums.album.images.url" :alt="albums.name">
            </div>
            <div class="card-btn">
              <div class="shrink">
